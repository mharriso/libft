...
void strlcpy_test()
{
   char  buf1[10] = "21";
   char  buf2[10] = "21";
   const char *str = "ssssssssssssssssssssssssssss";
   size_t sz1, sz2;
...
int main()
{
	...
	//atoi_test();
	//strlcpy_test();
	printf("%s$\n%s$\n\n", strnstr("123", "123", 3), ft_strnstr("123", "123", 3));
	printf("%s$\n%s$\n\n", strnstr("123", "123", 2), ft_strnstr("123", "123", 2));
	printf("%s$\n%s$\n\n", strnstr("", "", 0), ft_strnstr("", "", 0));
	printf("%s$\n%s$\n\n", strnstr("", "", 5), ft_strnstr("", "", 5));
	printf("%s$\n%s$\n\n", strnstr("1", "", 5), ft_strnstr("1", "", 5));
	printf("%s$\n%s$\n\n", strnstr("", "1", 5), ft_strnstr("", "1", 5));
	printf("%s$\n%s$\n\n", strnstr("", "1", 0), ft_strnstr("", "1", 0));
	printf("%s$\n%s$\n\n", strnstr("123405", "5", 5), ft_strnstr("123405", "5", 5));
